// Production narration uses saved recordings only. Never fall back to a browser
// voice: its quality varies by device and can sound robotic.
export class Narrator {
 ...
 async speak(sentences,settings,onSentence=()=>{},pauseMs=0){
  ...
  this.onStatus('This recording is not available yet. Please read it together.');return false;
 }
}
